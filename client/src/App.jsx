...
const Card = ({ title, children }) => (
  <div className="card p-8 max-w-2xl mx-auto my-8 text-center">
...
const App = () => {
	...
	return (
		<div>
			{!loading ? 
			<div className="h-full w-full flex flex-col items-center justify-center min-h-screen text-white">
			<header className="w-full fixed top-0 py-4 bg-gray-800 text-center text-4xl font-bold text-white shadow-md z-10">
				Deepfake Detection
			</header>


				<div className="text-2xl sm:text-4xl text-center absolute top-10 inset-x-0"></div>
				

				{!videoUrl && !imageUrl ? <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
					<div className="size-52">
						<label ref={hoverRef} className="flex flex-col-reverse items-center justify-center gap-3 bg-purple-400 size-52 rounded-xl p-3 border-2 border-black/70 border-dashed cursor-pointer hover:scale-105 duration-150">
					...
					<div className="size-52">
						<label ref={hoverRef2} className="flex flex-col-reverse items-center justify-center gap-3 bg-purple-400 size-52 rounded-xl p-3 border-2 border-black/70 border-dashed cursor-pointer hover:scale-105 duration-150">
